...
const DOCUMENT_VIEWER = Symbol(
  'document-viewer',
) as InjectionKey<DocumentViewer>
 ...
 */
export const provideDocumentViewer = (openDocument: DocumentViewer) =>
  provide(DOCUMENT_VIEWER, openDocument)
