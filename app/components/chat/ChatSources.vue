<template>
  <details
    ...
    class="rounded-lg border border-gray-200 bg-gray-50 text-sm dark:border-gray-800 dark:bg-gray-800"
  >
    <summary
      class="cursor-pointer px-3 py-2 text-xs font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
    >
    ...
    >
      <li v-for="(document, index) of documents" :key="index" class="px-3 py-2">
        ...
        <pre
          class="mt-1 overflow-x-auto text-xs whitespace-pre-wrap text-gray-600 dark:text-gray-400"
...
const preview = (document: ChatSourceDocument) =>
